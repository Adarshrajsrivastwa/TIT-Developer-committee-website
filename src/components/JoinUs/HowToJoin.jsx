      ...
      <div className="container mx-auto px-4">
        ...
        <div ref={pathwaysContainerRef} className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
          {filteredPathways.map((pathway) => (
            <div
              key={pathway.id}
              className="bg-white dark:bg-gray-700 rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-none hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 group"
            >
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200">{pathway.title}</h3>
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4 text-sm">{pathway.description}</p>

              <div className="mb-4">
                <h4 className="text-md font-semibold text-gray-700 dark:text-gray-200 mb-2">Selection Process</h4>
              ...
              <div className="mb-4">
                <h4 className="text-md font-semibold text-gray-700 dark:text-gray-200 mb-2">Rewards & Benefits</h4>
                <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
              ...
              <a
                ...
                className="w-full bg-indigo-600 dark:bg-indigo-900 hover:bg-indigo-700 dark:hover:bg-indigo-700 text-white text-center py-3 rounded-lg font-medium transition-colors duration-300 flex items-center justify-center"
              >
